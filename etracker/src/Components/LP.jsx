    ...
    <>
      ...
      <div id="parentdiv">
        ...
        <div id="herosection">
          ...
          <h2 id="h2Invest">Expenses in <br />an Ease</h2>
          <br />
     ...
     <Link to="/expense" className="LinkButton"><button class="button-86">Get Started</button></Link>
      ...
      <div id="parentdiv2">
        <div id="header">
          ...
          <h5>
          Effortlessly manage and track your expenses with our intuitive expense tracking app.
          <br /><br />
           Streamline financial control, gain insights, and stay organized on the go
          </h5>
        </div>
        <div id="tab">
          <div className="tabchild">
            ...
            <h5 className="h5tab">
              Get updates on your expenses if they<br /> get out of your budget.
            </h5>
          </div>
      ...
      <div id="parentdiv3">
        ...
        <div id="tab-container">
          <div className="tabs">
            ...
            <p>
              "ExpenseMitra, the ultimate game changer for managing my expenses, Now offcourse,
               I don't need to keep every of my spending written on my hand. I've got skin in 
               the financial game, owning a solid 10% of Expense Tracker, Like Pied Piper.
               And let's not forget, I have made strategic moves like selling my company Aviato. 
               in the end,
                based on my very good track record, I Highly recommend this to everyone,
                 because missing a part of your money is so last season!"
            </p>
            <p></p>
          </div>
          ...
          <div className="tabs">
            ...
            <p>
              "An unparalleled masterpiece in the realm of tracking my finances! ExpenseMitra, With its cutting-edge features, I can
              effortlessly gauge how much ground I need to cover in my savings and finances to outshine even the likes of Jeff Bezos. The features
          ...
          <div className="tabs">
            ...
            <p>
              People, let me tell you, this app ExpenseMitra, is the Elon Musk of
              expense trackers! It's like having a rocket strapped to my
              finances, the features are extraordianry that hit harder
              than a SpaceX launch, and my tres comma club? Oh, it's thriving!
              Thanks to ExpenseMitra, I'm not just tracking; I'm cruising
